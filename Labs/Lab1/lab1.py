...
def load_reviews_data(reviews_data_path):
    ...
    sentiment ,productId, userId, summary, text, helpfulY, helpfulN = csv.DictReader(reviews_data_path)

    return sentiment,productId,userId,summary,text,helpfulY, helpfulN
